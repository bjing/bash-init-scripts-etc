-- .xmonad/xmonad.hs
-- Or get a default template from http://code.haskell.org/xmonad/man/xmonad.hs
...
myStartupHook = do
    ...
    spawnOnce "compton &"
    spawnOnce "/home/brian/.screenlayout/home.sh"
...
--
main = do
    xmproc <- spawnPipe "xmobar /home/brian/.config/xmobar/xmobarrc"
